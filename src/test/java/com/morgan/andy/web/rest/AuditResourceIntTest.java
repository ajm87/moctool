...
import com.morgan.andy.config.audit.AuditEventConverter;
import com.morgan.andy.domain.PersistentAuditEvent;
import com.morgan.andy.repository.PersistenceAuditEventRepository;
import com.morgan.andy.service.AuditEventService;
...
@SpringBootTest(classes = MoctoolApp.class)
@Transactional
