...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/angular-bootstrap-datetimepicker/src/js/datetimepicker.js',
            'src/main/webapp/bower_components/angular-bootstrap-datetimepicker/src/js/datetimepicker.templates.js',
