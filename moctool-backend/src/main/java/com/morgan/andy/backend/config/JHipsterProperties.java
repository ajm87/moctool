...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "moctool@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "moctool API";

        private String description = "moctool API documentation";
